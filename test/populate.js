...
const cat = { name: "cat", type: "mammal", breed: "capuchin", color: "black/white", "age": 4};
...
const dog = { name: "dog", type: "mammal", breed: "capuchin", color: "black/white", "age": 4};
...
const goldfish = { name: "goldfish", type: "mammal", breed: "capuchin", color: "black/white", "age": 4};
...
const heron = { name: "heron", type: "mammal", breed: "capuchin", color: "black/white", "age": 4};
...
const alligator = { name: "alligator", type: "mammal", breed: "capuchin", color: "black/white", "age": 4};
